...
avatar1 =
  UserContent.create_avatar(%{
    ...
    user_content_data:
      process_file.("priv/repo/test_content/test_avatar1.scn", "application/octet-stream"),
...
scene1 =
  UserContent.create_map(%{
    ...
    user_content_data:
      process_file.("priv/repo/test_content/test_scene1.scn", "application/octet-stream"),
    uploader_id: uploader,
    user_content_preview: process_file.("priv/repo/test_content/test_image.jpg", "image/jpeg"),
    is_public: true
  })
...
scene2 =
  UserContent.create_map(%{
    ...
    user_content_data:
      process_file.("priv/repo/test_content/test_scene2.scn", "application/octet-stream"),
    uploader_id: uploader,
    user_content_preview: process_file.("priv/repo/test_content/test_image.jpg", "image/jpeg"),
    is_public: true
  })
